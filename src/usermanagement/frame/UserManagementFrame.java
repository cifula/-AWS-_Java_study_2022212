		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JOptionPane.showMessageDialog(null, "서버에연결할 수 없습니다.", "접속실패", JOptionPane.ERROR_MESSAGE);
		...
		registerButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, responseDto.getBody(),"ok",JOptionPane.INFORMATION_MESSAGE);
					mainCard.show(mainPanel, "loginPanel");
